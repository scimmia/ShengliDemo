...
public class SelfUploadController {
    private final static Logger log = LoggerFactory.getLogger(SelfUploadController.class);
    @Autowired
    ...
    public @ResponseBody String uploadSelfDescribe(
        ...
        String id = new SelfUploadDao(jdbcTemplate).insertDescribe(idcard,orgCode,selfDescribe, uploadtype);
